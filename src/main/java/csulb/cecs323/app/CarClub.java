...
public class CarClub {
   ...
   public static void main(String[] args) {
      ...
      //Create cars list in database
      List <Cars> cars = new ArrayList<Cars>();
      cars.add(new Cars("4S3BK4355T6319316", "Mazda", "CX-5", 2019, owners.get(0)));
      cars.add(new Cars("1C6RD6KT4CS332867", "Mazda", "CX-5", 2019, owners.get(0)));
      cars.add(new Cars("JHMCG56492C003897", "Toyota", "4-Runner", 2021, owners.get(1)));
      cars.add(new Cars("1B7GG2AN9YS629756", "Toyota", "Rav-4", 2018, owners.get(1)));
      cars.add(new Cars("JH4DB1670LS801802", "Honda", "Civic", 2011, owners.get(2)));
      cars.add(new Cars("5FNRL38918B111818", "Honda", "Accord", 2015, owners.get(2)));
